                    ...
                    <div className="container">
                        ...
                        <div className="lead text-center w-100">
                          <h1 className="display-4 text-center w-100 font-weight-bold mb-5">Meist.</h1>
                            ...
                            <p>Otsustasime avada rattahoolduse/poe Laagris, kuna ka ise elame siin ja teame, et paljud sõidavad siin ratastega, aga rattapoodi kuskil lähedal ei ole.</p>
                        </div>
                        </div>
                        </div>
                </section>
